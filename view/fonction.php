...
<div class="row featurette">
  <div class="col-md-7">
    ...
    ?>
    <h2 class="featurette-heading fw-normal lh-1">Espace integrations fonctions.</h2>
...
<div class="table-responsive">
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <span>La fonction <?=$list['nom']?> </span>
        </div>
        <div class="modal-footer">
          ...
          <button type="submit" name="delete_fonction" class="btn btn-primary">Oui</button>
          </form>
        </div>
      </div>
    </div>
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header">
          <h1 class="modal-title fs-5" id="exampleModalLabel">Création Fonction</h1>
          <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
        </div>
        <div class="d-flex">
            ...
            <div class="form-group mb-4">
                ...
                <textarea name="description" require id="" cols="30" class="form-control" rows="10"></textarea>
            </div>
        </div>
       <div class="d-flex">
            <button type="submit" class="btn btn-success" name="save_fonction">Enregistrer</button>   
       </div>
        </div>
